...
git_clone_pull casablanca https://raw.githubusercontent.com/Microsoft/cpprestsdk/master/Release/ || { echo 'Unable to download casablanca from codeplex'; exit 99; }
